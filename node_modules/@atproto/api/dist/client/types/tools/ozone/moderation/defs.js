...
exports.isAgeAssurancePurgeEvent = isAgeAssurancePurgeEvent;
exports.validateAgeAssurancePurgeEvent = validateAgeAssurancePurgeEvent;
...
function isAgeAssurancePurgeEvent(v) {
    return is$typed(v, id, hashAgeAssurancePurgeEvent);
}
function validateAgeAssurancePurgeEvent(v) {
